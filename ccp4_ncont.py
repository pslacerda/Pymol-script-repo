...
__PYMOL_META__ = {
    'name': 'ccp4_ncont',
    'description': """
        Parses CCP4/NCONT log file and selects residues and atoms.
        http://www.ccp4.ac.uk/html/ncont.html
    """,
    'authors': ['Gerhard Reitmayr', 'Dalia Daujotyte'],
    'license': 'GPL-2.0',
    'version': '__NO_VERSION__',
    'homepage': 'http://www.pymolwiki.org/index.php/ccp4_ncont',
}
...
def ccp4_ncont(contactsfile, selName1="source", selName2="target"):
    ...
    http://www.ccp4.ac.uk/html/ncont.html
    http://www.pymolwiki.org/index.php/ccp4_ncont
